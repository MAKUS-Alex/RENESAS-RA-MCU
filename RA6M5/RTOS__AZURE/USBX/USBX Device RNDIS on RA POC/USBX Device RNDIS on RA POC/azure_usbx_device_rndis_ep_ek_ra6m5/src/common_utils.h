...
#define MODULE_NAME             "USBX_DEVICE_RNDIS"
#define BANNER_INFO             "\r\n********************************************************************************"\
...
#error "block size is essential to use RTT-rtos aware framework"
#else
...
typedef enum event_id
{
    ...
    RTT_OUTPUT_MESSAGE_APP_PRINT_SERVER_IP,
    RTT_OUTPUT_MESSAGE_APP_PRINT_DNS_SERVER_IP,
    RTT_OUTPUT_MESSAGE_APP_PRINT_GATEWAY,
}event_id_t;
